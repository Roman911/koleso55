...
const HeaderMain: FC<Props> = ({ settings }) => {
	...
	return (
		<Navbar
			...
			classNames={ { menu: 'font-bold w-20', toggleIcon: 'w-20 text-red-500', menuItem: 'w-20', wrapper: twMerge('grid h-40 md:h-16 items-center justify-normal py-3 px-4 grid-cols-2 lg:grid-cols-[220px_420px_auto_150px]', styles['container']) } }
		>
